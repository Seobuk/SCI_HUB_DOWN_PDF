...
HEADERS = {'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Safari/537.36'}
...
class SciHub(object):
    ...
    def _get_available_scihub_urls(self):
        ...
        '''
        urls = []
        res = requests.get('https://sci-hub.now.sh/', verify=False)
